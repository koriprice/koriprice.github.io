...
### Week 10 Update
This week, I completed the Leadership: Practical Skills course. Like last week, this course was a little different than I was expecting. It was mostly geared toward people in management positions to help them improve their leadership. However, I do still think that a lot of the concepts can be applied even if I am not actively seeking out a managerial role. For example, the course emphasized the importance of motivation, and stated that a good leader knows how to motivate their team. Something that I also enjoyed was that this course went against the idea that leaders have to have a certain personality type. As someone who does not have the stereotypical "leader" personality, I found this to be very reassuring, and the course contained a lot of advice that anyone can easily apply regardless of their personality. One of my other main takeaways was that I need to improve on delegating. I tend to want to do everything myself, but this course made me realize that that is not always feasible, and that it can actually hurt the team overall if I am in a leadership position and I am trying to do everyone's job. This is definitely something that I'll be focusing on in the future. I also took and passed the exams for Learning to be Approachable and Communication Foundations.

Next week, I am going to be finishing up my leadership courses with Inspirational Leadership Skills. The Leadership in Tech course does not have an exam, so I will not be doing an exam next week. 
...
### Week 12 Update
This week, I completed the Get Ready for Your Coding Interview Course. In general, I really enjoyed this course and think that it will be very helpful to me in the future. I have never done a coding interview, and I think this course gave me a good idea of what to expect, as well as some good tips and resources. For example, the course mentioned that LeetCode and the book Cracking the Coding Interview are both excellent resources that you can use to practice, so I will be looking into those. Another helpful tip was to have practice interviews with friends so that you can get used to the format of a coding interview. The course also went through several examples of questions that could appear in a coding interview, which was very helpful. The way it was formatted, the question was presented in one video, and then I was able to work out a solution on my own before the next video, which showed the creator's solution. I thought this was very helpful, as I was able to compare my process and solution with the one offered in the course. Also, watching the explanation videos gave me a good template for how to explain my own solution effectively. 

Next week, I am going to be completing the Time Management Fundamentals and Tech Resume courses. Because I do not have a course exam next week, I think it would also be good to explore LeetCode to get in some coding interview practice. This way, I can start applying some of the things that I learned this week in place of a scored exam. 

I do not see any major impediments to completing these tasks. If anything, I think using LeetCode could be more time consuming than I am anticipating depending on the difficulty level of the questions/activities. Although, I am just using this for practice, so even if it is difficult it should not negatively impact my overall project or timeline.

To improve my process for next week, I think I should set aside some time to work on my resume. Because I am going to be doing the course on building a resume, this will be a useful application of the knowledge that I get from that. Also, if I have a good resume already put together, it should make my job searching process faster when I do start applying. To ensure that I have the time to do this, I think it will be beneficial to do the resume course first, and make sure that I start early in the week so that I have enough time to accomplish all of my goals. 
